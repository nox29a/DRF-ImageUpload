# Generated by Django 4.0.5 on 2022-07-01 11:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail200', models.URLField(blank=True, null=True)),
                ('thumbnail400', models.URLField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='owner',
            name='status',
            field=models.ForeignKey(default='1', null=True, on_delete=django.db.models.deletion.PROTECT, to='upload.tier'),
        ),
        migrations.AddField(
            model_name='owner',
